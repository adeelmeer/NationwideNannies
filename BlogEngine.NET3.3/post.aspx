...
<asp:content id="Content1" contentplaceholderid="cphBody" runat="Server">
    ...
    <%
        ...
        try
        {
            ...
            slug = rawUrl.Substring(index+1);

            string urlNationwideNannies = ConfigurationManager.AppSettings["nantionwideNanniesUrl"];
            string postUrl = string.Format("{0}/blog/post/{1}", urlNationwideNannies, slug);
...
<%--    <script>
        $(document).ready(function () {
            alert(<%System.Web.HttpContext.Current.Request.Url.PathAndQuery.ToString();%>);
        });
    </script>--%>
